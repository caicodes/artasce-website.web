 <!-- @/components/ColorModeSelect.vue -->
<template>
    <div ref="colormodes" class="flex items-center gap-4">
...
export default {
    ...
    setup() {
        ...
        const entranceAnimation = () => {
            animation.to(colormodes.value, { rotation: "+=360" });
            animation.to(colormodes.value, { rotation: "+=360" });
            animation.to(colormodes.value, { rotation: "+=720" });
        }
        ...
        return {
            colorMode, colormodes, entranceAnimation
        }
    }
}
